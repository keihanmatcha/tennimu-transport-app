# -*- coding: utf-8 -*-
"""transport_options11..ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1VIKL43aKqzKfKaSAcm9Yz7BifgFGq_6u
"""
...
# --------------------- タブ UI の構成 ---------------------
tab1, tab2, tab3,tab4 = st.tabs(["1.ホテルプラン検索", "2.交通費セレクター", "3.合計費用ランキング","4.宿泊＋交通費の合計ランキング（選択プラン反映）"])
